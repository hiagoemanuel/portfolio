...
export const ContactNetworks = () => {
  ...
  return (
    <div className="flex flex-col gap-3 sm:gap-6 items-center">
      <div>
        <h4 className="mb-2 sm:mb-4 text-xl sm:text-4xl font-bold text-center">minhas redes</h4>
      ...
      <div>
        <h4 className="mb-2 sm:mb-4 text-xl sm:text-4xl font-bold text-center">
          e-mail de contato
        </h4>
        <p className="text-sm sm:text-3xl font-medium text-center">{email}</p>
      </div>
    </div>
  )
}
